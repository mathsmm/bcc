...
void AppUtils::s_DrawVect(SDL_Renderer* renderer, Vect initialPos, Vect finalPos)
{
	...
	SDL_RenderDrawLine(
		...
		(int)finalPos.get_x(),
		(int)finalPos.get_y(),
		(int)finalPos.get_x() + (int)round(LArrowSegment.get_x()), 
		(int)finalPos.get_y() + (int)round(LArrowSegment.get_y())
	);
	...
	SDL_RenderDrawLine(
		...
		(int)finalPos.get_x(),
		(int)finalPos.get_y(),
		(int)finalPos.get_x() + (int)round(RArrowSegment.get_x()),
		(int)finalPos.get_y() + (int)round(RArrowSegment.get_y())
	);
